...
export default function Header() {
  ...
  return (
    <HeaderContainer>
      <FirstHeaderContainer>
        <LogoContainer>
          <Image src={Logo} alt="Logo da empresa Blog" />
        </LogoContainer>
      ...
      <SecondHeaderContainer>
        <LeftContent>
          ...
          <SubTitle>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nibh nibheu
            in aliquet ut adipiscing neque. Sed volutpat aenean sit vitae, sed
            tristique placerat hac.
          </SubTitle>
          <SeeMoreButton href="#">
            Veja mais
            <FaArrowRight color="#4FFF4B" />
          </SeeMoreButton>
        </LeftContent>
        <RightContent>
          <Image
            src={HeaderImage}
            alt="Imagem de códigos"
            layout="responsive"
          />
        </RightContent>
      </SecondHeaderContainer>
